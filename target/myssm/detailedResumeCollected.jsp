...
<div id="wrap">
    ...
    <div class="rightBody">
        ...
        <div class="detailResume_bottom">
            ...
            <input id="cancelCollectBtn" class="submit" type="button" value="取消收藏">
            <form id="invite" action="/detailedInfo.do/invitation"  >
                ...
                <input type="text" style="display: none" name="statusPage" value="detailedResumeCollected.jsp">
                <input id="inviteResult" type="text" style="display: none" name="inviteResult" value="${inviteResult}">
                <script>
            ...
            <form id="cancelCollect" action="/collection/cancelCollectResume.do" >

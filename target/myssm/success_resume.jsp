...
<div id="wrap">
    ...
    <div class="rightBody">
        <c:forEach var="divResume" varStatus="i" items="${sessionScope.successResumes}">
            <form class="divResume" action="/detailedInfo.do/resume" method="get">
                ...
                <span>${divResume.age}岁</span>&nbsp;&nbsp;&nbsp;
                <span>${divResume.qualifications}</span>
                <span  class="major">专业：${divResume.major}</span>
                <input type="text" style="visibility: hidden" name="userId" value="${divResume.userId}">
                <input type="text" style="visibility: hidden" name="resumeName" value="${divResume.resumeName}">
                <input type="text" style="display: none" name="statusPage" value="success_resume.jsp">
            </form>
        </c:forEach>
    </div>
</div>

...
<div id="wrap">
    ...
    <div class="rightBody">
        ...
        <div class="detailResume_bottom">
            <input id="sendMsgBtn" class="submit" type="button" value="发送留言">
            <form id="sendMsg" action="/message.do/pc_send"  >
                ...
                留言：
                <textarea style="font-size: 18px; font-family: 宋体;" name="msg" id="" cols="30" rows="10"></textarea><br/><br/><br/>

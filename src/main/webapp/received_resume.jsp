...
<div id="wrap">
    ...
    <div class="rightBody">
        <c:forEach var="divResume" varStatus="i" items="${sessionScope.receivedResume}">
            <form class="divResume" action="/detailedInfo.do/resume" method="get">
                ...
                <input type="text" style="display: none" name="statusPage" value="received_resume.jsp">
        ...
        <input id="adoptStatus" type="text" style="display: none" name="adoptStatus" value="${adoptStatus}">
        <script>
            if ($("#adoptStatus").val() == "adopt success"){
                alert("已通过")
            }
        </script>
    </div>
